<!-- Modal crear tags instalaciones -->
<div class="modal fade" id="crearinstalacion" tabindex="-1" role="dialog" aria-labelledby="crearinstalacionLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h5 class="modal-title" id="crearinstalacionLabel">Nuevo Tags Instalaciones</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form method="POST" action="{{route('admin.instalacion.store')}}">
                @csrf
                <div class="modal-body">
                    <div class="row">
                        <div class="form-group col-12 col-md-12 col-sm-12">
                            <label for="instalacion">Tag Instalaciones</label>
                            <input type="text" class="form-control" name="instalacion" value="{{old('instalacion')}}" placeholder="instalaciones">
                        </div>
                        <div class="form-group col-12 col-md-12 col-sm-12">
...
<div class="modal fade" id="editarinstalacion" aria-hidden="true" >
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form name="custForm" action="{{ route('admin.instalacion.store') }}" method="POST">
                    <input type="hidden" name="cust_id" id="cust_id" >
                    @csrf
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                <strong>Tag Instalaciones</strong>
                                <input type="text" name="instalacion" id="instalacion" class="form-control" onchange="validate()" >
                            </div>
                        </div>                        
                        <div class="form-group col-12 col-md-12 col-sm-12">
                            <div class="custom-control custom-radio">
...
<script>
    function validate()
    {
        if(document.custForm.instalacion.value !='' && document.custForm.estatus.value !='' )
