...
<div class="card-body">
    <div class="row">
        ...
        <div class="form-group col-12 col-sm-12 col-md-4">
            ...
            <input type="text" class="form-control" name="codigo" value="{{old('codigo',$row->codigo)}}" id="codigo" placeholder="Codigo Proyecto">
        </div>
        <div class="form-group col-12 col-sm-12 col-md-4">
        ...
        <div class="form-group col-12 col-sm-12 col-md-6">
            <div class="row">
                ...
                <div class="col-3">
                    <label for="n_estacionamiento">N° Estac.<span style="color: red">*</span></label>
                ...
                <div class="col-3">
                    <label for="n_agua">Listros Agua</label>
                    <input type="text" class="form-control" name="n_agua" value="{{old('n_agua',$row->n_agua)}}" id="slug" placeholder="1">
                </div>
            </div>
        </div>
        <div class="form-group col-12 col-sm-12 col-md-6">
...
<div class="row">
    <div class="m-3">
        ...
        <a href="{{route('admin.proyecto.index')}}" class="btn btn-danger">Cancelar</a>
    </div>
</div>
